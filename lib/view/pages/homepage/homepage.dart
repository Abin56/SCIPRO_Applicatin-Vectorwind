              ...
              crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                    ...
                    Padding(
                      ...
                      child: GooglePoppinsWidgets(text: 'Hello...', fontsize: 19.sp,fontWeight: FontWeight.w300,color: Colors.black,),
                    ),
                 Padding(
                   padding:  EdgeInsets.only(top: 10.h),
                   child: GooglePoppinsWidgets(text: 'Nainika v', fontsize: 20.sp,color: cBlack,fontWeight: FontWeight.bold,),
                 ),
                 Padding(
